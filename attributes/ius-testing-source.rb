...
default['yum']['ius-testing-source']['description'] = 'IUS Community Packages for Enterprise Linux $releasever - $basearch Testing Source'
default['yum']['ius-testing-source']['mirrorlist'] = case node['platform']
                                                     when 'redhat'
                                                       'https://mirrors.iuscommunity.org/mirrorlist/?repo=ius-el$releasever-testing-source&arch=$basearch&protocol=http'
                                                     else
                                                       'https://mirrors.iuscommunity.org/mirrorlist/?repo=ius-centos$releasever-testing-source&arch=$basearch&protocol=http'
                                                     end
