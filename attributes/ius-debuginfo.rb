...
default['yum']['ius-debuginfo']['description'] = 'IUS Community Packages for Enterprise Linux $releasever - $basearch Debug'
default['yum']['ius-debuginfo']['mirrorlist'] = case node['platform']
                                                when 'redhat'
                                                  'https://mirrors.iuscommunity.org/mirrorlist/?repo=ius-el$releasever-debuginfo&arch=$basearch&protocol=http'
                                                else
                                                  'https://mirrors.iuscommunity.org/mirrorlist/?repo=ius-centos$releasever-debuginfo&arch=$basearch&protocol=http'
                                                end
