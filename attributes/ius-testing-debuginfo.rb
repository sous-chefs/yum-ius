...
default['yum']['ius-testing-debuginfo']['description'] = 'IUS Community Packages for Enterprise Linux $releasever - $basearch Testing Debug'
default['yum']['ius-testing-debuginfo']['mirrorlist'] = case node['platform']
                                                        when 'redhat'
                                                          'https://mirrors.iuscommunity.org/mirrorlist/?repo=ius-el$releasever-testing-debuginfo&arch=$basearch&protocol=http'
                                                        else
                                                          'https://mirrors.iuscommunity.org/mirrorlist/?repo=ius-centos$releasever-testing-debuginfo&arch=$basearch&protocol=http'
                                                        end
