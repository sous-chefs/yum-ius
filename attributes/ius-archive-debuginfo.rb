...
default['yum']['ius-archive-debuginfo']['description'] = 'IUS Community Packages for Enterprise Linux $releasever - $basearch Archive Debug'
default['yum']['ius-archive-debuginfo']['mirrorlist'] =  case node['platform']
                                                         when 'redhat'
                                                           'https://mirrors.iuscommunity.org/mirrorlist/?repo=ius-el$releasever-archive-debuginfo&arch=$basearch&protocol=http'
                                                         else
                                                           'https://mirrors.iuscommunity.org/mirrorlist/?repo=ius-centos$releasever-archive-debuginfo&arch=$basearch&protocol=http'
                                                         end
