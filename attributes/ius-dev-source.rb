...
default['yum']['ius-dev-source']['description'] = 'IUS Community Packages for Enterprise Linux $releasever - $basearch Dev Source'
default['yum']['ius-dev-source']['mirrorlist'] = case node['platform']
                                                 when 'redhat'
                                                   'https://mirrors.iuscommunity.org/mirrorlist/?repo=ius-el$releasever-dev-source&arch=$basearch&protocol=http'
                                                 else
                                                   'https://mirrors.iuscommunity.org/mirrorlist/?repo=ius-centos$releasever-dev-source&arch=$basearch&protocol=http'
                                                 end
