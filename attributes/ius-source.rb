...
default['yum']['ius-source']['description'] = 'IUS Community Packages for Enterprise Linux $releasever - $basearch Source'
default['yum']['ius-source']['mirrorlist'] = case node['platform']
                                             when 'redhat'
                                               'https://mirrors.iuscommunity.org/mirrorlist/?repo=ius-el$releasever-source&arch=$basearch&protocol=http'
                                             else
                                               'https://mirrors.iuscommunity.org/mirrorlist/?repo=ius-centos$releasever-source&arch=$basearch&protocol=http'
                                             end
