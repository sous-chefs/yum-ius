...
default['yum']['ius']['description'] = 'IUS Community Packages for Enterprise Linux $releasever - $basearch'
default['yum']['ius']['mirrorlist'] = case node['platform']
                                      when 'redhat'
                                        'https://mirrors.iuscommunity.org/mirrorlist/?repo=ius-el$releasever&arch=$basearch&protocol=http'
                                      else
                                        'https://mirrors.iuscommunity.org/mirrorlist/?repo=ius-centos$releasever&arch=$basearch&protocol=http'
                                      end
