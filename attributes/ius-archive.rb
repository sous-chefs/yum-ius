...
default['yum']['ius-archive']['description'] = 'IUS Community Packages for Enterprise Linux $releasever - $basearch Archive'
default['yum']['ius-archive']['mirrorlist'] = case node['platform']
                                              when 'redhat'
                                                'https://mirrors.iuscommunity.org/mirrorlist/?repo=ius-el$releasever-archive&arch=$basearch&protocol=http'
                                              else
                                                'https://mirrors.iuscommunity.org/mirrorlist/?repo=ius-centos$releasever-archive&arch=$basearch&protocol=http'
                                              end
