...
default['yum']['ius-dev-debuginfo']['description'] = 'IUS Community Packages for Enterprise Linux $releasever - $basearch Dev Debug Info'
default['yum']['ius-dev-debuginfo']['mirrorlist'] = case node['platform']
                                                    when 'redhat'
                                                      'https://mirrors.iuscommunity.org/mirrorlist/?repo=ius-el$releasever-dev-debuginfo&arch=$basearch&protocol=http'
                                                    else
                                                      'https://mirrors.iuscommunity.org/mirrorlist/?repo=ius-centos$releasever-dev-debuginfo&arch=$basearch&protocol=http'
                                                    end
